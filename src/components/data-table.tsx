...
// React 18's ReactNode types exclude bigint, while TanStack Table v9 includes it in FlexRender's return type.
const ReactFlexRender = FlexRender as unknown as React.ComponentType<any>
